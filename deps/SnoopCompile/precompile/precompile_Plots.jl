...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(plot!)),NamedTuple{(:alpha, :seriestype),Tuple{Float64,Symbol}},typeof(plot!),Plot{PlotlyBackend},Array{GeometryBasics.Point{2,Float64},1}})
    ...
    isdefined(Plots, Symbol("#143#144")) && Base.precompile(Tuple{getfield(Plots, Symbol("#143#144")),Tuple{Int64,Expr}})
